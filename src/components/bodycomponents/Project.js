  ...
  const projectData = [
    {
      ...
      description:
        "Equipment rental website for renting with searchbar and add-to-cart feature.",
      ...
      <Box className="projectCard">
        {projectData.map((item, i) => (
          <Card sx={{ maxWidth: 345 }}>
            ...
            <CardActions>
              <a
                href="https://shiny-alpaca-b00810.netlify.app/"
                target="_blank"
                className="demo"
              >
                {" "}
              ...
              <a
                href="https://github.com/AyushiPohekar/guvi-hacathon-2-frontend"
                target="_blank"
                className="demo"
              >
                {" "}
              ...
              <a
                href="https://github.com/AyushiPohekar/guvi-hacathon2-backend"
                target="_blank"
                className="demo"
              >
                {" "}
